  ...
  if(value==""){
    ...
    alert("Invalid Phone Number");
      ...
      if(Duration =="1 Year"){
        ...
        document.getElementById("Installment Amount").innerText=(Amount*1.15)/12;
        document.getElementById("Intrest Rate").style.visibility="Visible";
        document.getElementById("Installment Amount").style.visibility="Visible";
      }
      if(Duration =="2 Year"){
        document.getElementById("Intrest Rate").innerText="18%";
        document.getElementById("Installment Amount").innerText=(Amount*1.18)/24;
        document.getElementById("Intrest Rate").style.visibility="Visible";
        document.getElementById("Installment Amount").style.visibility="Visible";
      }
      if(Duration =="3 Year"){
        document.getElementById("Intrest Rate").innerText="21%";
        document.getElementById("Installment Amount").innerText=(Amount*1.21)/36;
        document.getElementById("Intrest Rate").style.visibility="Visible";
        document.getElementById("Installment Amount").style.visibility="Visible";
      }
      if(Duration =="4 Year"){
        document.getElementById("Intrest Rate").innerText="24%";
        document.getElementById("Installment Amount").innerText=(Amount*1.24)/48;
        document.getElementById("Intrest Rate").style.visibility="Visible";
        document.getElementById("Installment Amount").style.visibility="Visible";
      }
      if(Duration =="5 Year"){
        document.getElementById("Intrest Rate").innerText="27%";
        document.getElementById("Installment Amount").innerText=(Amount*1.27)/60;
        document.getElementById("Intrest Rate").style.visibility="Visible";
        document.getElementById("Installment Amount").style.visibility="Visible";
      }
  }
    ...
    if(Duration =="1 Year"){
      ...
      document.getElementById("Installment Amount").innerText=(Amount*1.9)/12;
      document.getElementById("Intrest Rate").style.visibility="Visible";
      document.getElementById("Installment Amount").style.visibility="Visible";
    }
    if(Duration =="2 Year"){
      document.getElementById("Intrest Rate").innerText="12%";
      document.getElementById("Installment Amount").innerText=(Amount*1.12)/24;
      document.getElementById("Intrest Rate").style.visibility="Visible";
      document.getElementById("Installment Amount").style.visibility="Visible";
    }
    if(Duration =="3 Year"){
      document.getElementById("Intrest Rate").innerText="15%";
      document.getElementById("Installment Amount").innerText=(Amount*1.15)/36;
      document.getElementById("Intrest Rate").style.visibility="Visible";
      document.getElementById("Installment Amount").style.visibility="Visible";
    }
    if(Duration =="4 Year"){
      document.getElementById("Intrest Rate").innerText="18%";
      document.getElementById("Installment Amount").innerText=(Amount*1.18)/48;
      document.getElementById("Intrest Rate").style.visibility="Visible";
      document.getElementById("Installment Amount").style.visibility="Visible";
    }
    if(Duration =="5 Year"){
      document.getElementById("Intrest Rate").innerText="21%";
      document.getElementById("Installment Amount").innerText=(Amount*1.21)/60;
      document.getElementById("Intrest Rate").style.visibility="Visible";
      document.getElementById("Installment Amount").style.visibility="Visible";
    }
  }
